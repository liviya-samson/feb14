...
var FormController = /*#__PURE__*/function () {
  function FormController(options) {
    ...
    this.debouncedValidateAsync = utils.debounceByName(this.validateAsync);
    this.debouncedGatherInfo = utils.debounceByName(this.gatherData);
  ...
  _rollupPluginBabelHelpers.createClass(FormController, [{
    ...
    value: function setValue(name, value, e, key, quiet) {
      ...
      if (value === '') {
        ...
        if (meta.formatter) {
          var res = utils.informedFormat(_val, meta.formatter, this.getMaskedValue(name));
    ...
    value: function touchAllFields() {
      ...
      this.fieldsMap.forEach(function (meta) {
        if (!meta.current.arrayField) {
          ...
          ObjectMap.ObjectMap.set(_this7.state.touched, meta.current.name, true);
        }
      });
    }
  }, {
