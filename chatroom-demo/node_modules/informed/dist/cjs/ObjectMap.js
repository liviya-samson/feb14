...
var debug = debug$1.Debug('informed:ObjMap' + '\t');
...
var ldset = function ldset(obj) {
  ...
  String.prototype.replace.call(path, /\['(.+?)'\]/g, '.$1').split(/[,[\].]+?/).filter(Boolean).reduce(function (res, key, i, arr) {
    ...
    // ==> { foo: { bar: 'HelloWorld' } }
    if (_rollupPluginBabelHelpers["typeof"](res[key]) !== 'object') {
...
var ObjectMap = /*#__PURE__*/function () {
  function ObjectMap() {
    _rollupPluginBabelHelpers.classCallCheck(this, ObjectMap);
  }
  _rollupPluginBabelHelpers.createClass(ObjectMap, null, [{
    key: "empty",
    ...
    value: function purge(obj) {
      ...
      Object.keys(obj).forEach(function (key) {
        // Its an object recur
        if (_rollupPluginBabelHelpers["typeof"](obj[key]) === 'object') {
