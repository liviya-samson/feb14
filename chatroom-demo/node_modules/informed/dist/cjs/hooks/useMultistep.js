...
var useMultistep = function useMultistep(_ref) {
  ...
  var nSteps = React.useRef(0);

  // Track current step
  var currentStep = React.useRef();
  ...
  var multistepApi = React.useMemo(function () {
    // ---------- Define the api functions ----------
    var register = function register(name, step) {
      // Create step meta
      var stepMeta = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, step), {}, {
    ...
    var proceed = function proceed(nextStep, cb) {
      ...
      if (cb && typeof cb === 'function') {
        ...
        var subState = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, fieldState), {}, {
  ...
  var render = function render(children) {
    return /*#__PURE__*/React__default["default"].createElement(Context.MultistepApiContext.Provider, {
      value: multistepApi
    }, /*#__PURE__*/React__default["default"].createElement(Context.MultistepStateContext.Provider, {
      value: multistepState
    }, children));
  };
  return _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, multistepApi), multistepState), {}, {
    render: render
  });
};
